...
var KTCreateAccount = function() {
    ...
    return {
        init: function() {
            (e = document.querySelector("#clients_app")) && new bootstrap.Modal(e), t = document.querySelector("#clients_app_stepper"), i = t.querySelector("#clientform"), o = t.querySelector('[data-kt-stepper-action="submit"]'), s = t.querySelector('[data-kt-stepper-action="next"]'), (r = new KTStepper(t)).on("kt.stepper.changed", (function(e) {
