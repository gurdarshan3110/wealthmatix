    ...
    <script type="text/javascript">
        ...
        var table=$('#record-table').DataTable({
                ...
                "drawCallback": function () {
                    ...
                    $('.dt-buttons button').addClass('fs-7 active-menu-variant text-light border-0');
                    $('.dt-buttons').addClass('mb-2');
                    $('.dt-button').addClass('btn-primary');
                    $('.paginate_button').addClass('fs-7');
                    $('.paginate_button.current').addClass('fs-7 active-menu-variant');
                    $('.paginate_button.active-menu-variant').removeClass('current');
            ...
            $('#filter').click(function(){
                var min=$('#min').val();
                var max=$('#max').val();
                table.ajax.url( '/variants/list?min='+min+'&max='+max ).load();
            });
    </script>
@endpush
