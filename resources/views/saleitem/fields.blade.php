...
<div class="form-group col-sm-6">
    {!! Form::label('bill_date', 'Sale Date:') !!}
    {!! Form::date('bill_date', null, ['class' => 'form-control']) !!}
</div>

<div class="form-group col-sm-6">
    {!! Form::label('transfered_to', 'Sale to:') !!}
    <input type="text" name="sale" id="sale" class="form-control typeahead sale" placeholder="Type to search...">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.sale').typeahead({
            ...
            templates: {
                suggestion: function(data) {
                    return '<div>' + data.name +' (Ph No : '+data.phone_no+')'+  '</div>';
                }
            }
        ...
        function calculateAmount(row) {
            var salePrice = parseFloat(row.find('.sale_price').val()) || 0;
        ...
        $(document).on('input', '.sale_price, .quantity', function() {
